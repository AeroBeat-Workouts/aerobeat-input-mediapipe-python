...
func assert_string_contains(_value, _needle, _message: String = "") -> void:
	pass

func assert_has_method(_value, _method, _message: String = "") -> void:
	pass
...
func pending(_message: String = "") -> void:
	pass
